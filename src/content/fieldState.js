 ...
 * - Exposes clean statistics for Member 3's Popup UI.
 */
...
class FieldStateManager {
  constructor() {
    ...
    this.fieldStatusMap = new Map(); // fieldId -> { status, value, confidence, label }
  }
  ...
  /**
   * Records the AI matching results.
   *
  ...
  getStats() {
    ...
    // Any detected field that was not explicitly returned in matching results is treated as unmatched
   ...
   * for passing into Member 4's save prompt logic.
   *
