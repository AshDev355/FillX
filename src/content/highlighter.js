 ...
 * - UNMATCHED: No match found, requires manual entry (dashed red/orange outline + badge)
 *
 * Features:
 * - Caches original inline styles to prevent permanently modifying host page styles
 ...
 * @param {'MATCHED'|'AMBIGUOUS'|'UNMATCHED'} state
...
function attachBadge(element, state, customLabel) {
  ...
  // Remove existing badge for this field if present
  removeBadge(element);
  ...
  // Position badge right above or near the top-right corner of the element
...
/**
 * Highlights a field as successfully MATCHED (green).
 *
 * @param {HTMLElement} element
 * @param {object} [options]
 */
...
/**
 * Highlights a field as AMBIGUOUS (amber / review needed).
 *
 * @param {HTMLElement} element
 * @param {object} [options]
 */
...
/**
 * Highlights a field as UNMATCHED (red / manual entry needed).
 *
 * @param {HTMLElement} element
 * @param {object} [options]
 */
...
/**
 * Clears highlight from a single element and restores its original inline style.
 *
 * @param {HTMLElement} element
 */
...
/**
 * Clears all highlights and badges across the entire document.
 */
