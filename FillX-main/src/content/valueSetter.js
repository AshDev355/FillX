...
/**
 * Dispatches full sequence of synthetic DOM events to trigger reactive framework state updates.
 *
...
export function dispatchFormEvents(element) {
  ...
  // 2. Input event (crucial for React, Vue, Angular)
  ...
  // 3. Change event (crucial for selects, radio buttons, checkboxes, validation)
...
export function setFieldValue(element, value) {
  ...
  try {
    ...
    return { success: false, error: `Unsupported element: ${tagName}` };
  } catch (err) {
